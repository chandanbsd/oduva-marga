...
the constitution says _what_ is required (e.g. constructor injection,
...
nobody should have to re-derive _why_ Keycloak sits fully public, or _why_
...
_because_ they were blocking Dockerfile verification, not because they were
